@extends('product.layouts.front-dashboard')
            ...
            <div class="row y-gap-20">
                ...
                <div class="col-lg-4 col-md-5">
                    <div class="product-image-wrapper">
                        <img src="{{ $requestedOrder->flowerProduct->product_image }}" alt="Product Image" class="rounded-8 w-100"  onerror="this.onerror=null; this.src='{{ asset('front-assets/img/general/1.jpg') }}';">
                    </div>
                </div>
