      ...
      <div class="col-md-12">
            <div class="order-history-sec">
                ...
                <div class="row order-details-booking">
                    <div class="col-md-2">
                        <img src="{{ $order->flowerProduct->product_image }}" alt="Product Image"  onerror="this.onerror=null; this.src='{{ asset('front-assets/img/general/1.jpg') }}';"/> <!-- Display product image -->
                    </div>
                    <div class="col-md-7">
